...
void biblequote::loadBibleData(int bibleID,QString path)
{
        ...
        if (file.open(QIODevice::ReadOnly | QIODevice::Text))
        {
                ...
                while (!file.atEnd())
                {
                        ...
                        //qDebug() << "biblequote::loadBibleData bookCount = " << bookCount;
                        //qDebug() << "biblequote::loadBibleData bookfullName = " << bookFullName;
                        //qDebug() << "biblequote::loadBibleData bookPath = " << bookPath;
                        //qDebug() << "biblequote::loadBibleData bookShortName = " << bookShortName;
                }
