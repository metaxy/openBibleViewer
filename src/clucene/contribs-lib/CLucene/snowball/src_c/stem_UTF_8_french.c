...
static int r_i_verb_suffix(struct SN_env * z)
{
    int among_var;
    {
        ...
        case 1:
            if(!(out_grouping_b_U(z, g_v, 97, 251))) {
                z->lb = m3;
                return 0;
            }
            {
...
static int r_residual_suffix(struct SN_env * z)
{
    int among_var;
    {
        ...
        z->bra = z->c; /* ], line 190 */
        {
            ...
            if(!(out_grouping_b_U(z, g_keep_with_s, 97, 232))) {
                z->c = z->l - m;
                goto lab0;
            }
            z->c = z->l - m_test;
