...
{
    {
        ...
        z->ket = z->c; /* [, line 172 */
        if(!(in_grouping_b_U(z, g_AEIO, 97, 242))) {
            z->c = z->l - m;
            goto lab0;
        }
        z->bra = z->c; /* ], line 172 */
    ...
    }
    {
        ...
        z->bra = z->c; /* ], line 176 */
        if(!(in_grouping_b_U(z, g_CG, 99, 103))) {
            z->c = z->l - m;
            goto lab1;
        }
        {
