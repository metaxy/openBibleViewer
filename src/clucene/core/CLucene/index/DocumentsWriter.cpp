...
int64_t DocumentsWriter::ByteSliceReader::getFilePointer() const
{
    _CLTHROWA(CL_ERR_Runtime, "not implemented");
}
int64_t DocumentsWriter::ByteSliceReader::length() const
{
    _CLTHROWA(CL_ERR_Runtime, "not implemented");
}
void DocumentsWriter::ByteSliceReader::seek(const int64_t /*pos*/)
{
    _CLTHROWA(CL_ERR_Runtime, "not implemented");
}
void DocumentsWriter::ByteSliceReader::close()
{
    _CLTHROWA(CL_ERR_Runtime, "not implemented");
}
