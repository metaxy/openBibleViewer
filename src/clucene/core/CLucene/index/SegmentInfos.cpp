...
int32_t SegmentInfo::getDocStoreOffset() const
{
    return docStoreOffset;
}

bool SegmentInfo::getDocStoreIsCompoundFile() const
{
...
int64_t SegmentInfos::getVersion() const
{
    return version;
}
int64_t SegmentInfos::getGeneration() const
{
    return generation;
}
int64_t SegmentInfos::getLastGeneration() const
{
