...
void BooleanQuery::setCoordDisabled(bool disableCoord)
{
    this->disableCoord = disableCoord;
}
...
float_t BooleanWeight::getValue()
{
    return parentQuery->getBoost();
}
Query* BooleanWeight::getQuery()
{
...
BooleanClause::Occur BooleanClause::getOccur() const
{
    return occur;
}
...
Query* BooleanClause::getQuery() const
{
    return query;
}
...
bool BooleanClause::isProhibited() const
{
    return prohibited; /* TODO: return (occur == MUST_NOT); */
}
bool BooleanClause::isRequired() const
{
    return required; /* TODO: return (occur == MUST); */
}
