...
public:
    ...
    const char* getDirectoryType() const {
        return FSDirectory::getClassName();
    }
...
void FSDirectory::setUseMMap(bool value)
{
    useMMap = value;
}
bool FSDirectory::getUseMMap() const
{
    return useMMap;
}
...
void FSDirectory::setDisableLocks(bool doDisableLocks)
{
    disableLocks = doDisableLocks;
}
bool FSDirectory::getDisableLocks()
{
    return disableLocks;
}
