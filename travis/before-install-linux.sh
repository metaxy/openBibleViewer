...
sudo apt-get install -qq --no-install-recommends clang osc libquazip1 libquazip-dev zlib1g-dev qt5-default qttools5-dev-tools qtscript5-dev libqt5webkit5-dev
