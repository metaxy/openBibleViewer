...
sudo apt-get install -qq --no-install-recommends clang osc libquazip-dev libquazip-dev zlib1g-dev qt5-default qttools5-dev-tools qtscript5-dev  libqt5webkit5-dev libclucene-core1
